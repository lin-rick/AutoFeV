...
def loadKNNDataAndTrainKNN():
    ...
    try:
        npaClassifications = np.loadtxt("classifications4.txt", np.float32)                  # read in training classifications
    ...
    try:
        npaFlattenedImages = np.loadtxt("flattened_images4.txt", np.float32)                 # read in training images
    except:                                                                                 # if file could not be opened
